...
const PopUpForm = () => {
  ...
  return (
    <section
      className={`fixed inset-0 z-999999 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm ${isOpenFormPopUp ? "visible opacity-100" : "invisible opacity-0"} `}
    >
